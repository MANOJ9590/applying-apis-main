...
public class RepositoriesPicker {
    ...
    private static final String USERNAME_AND_TOKEN = "user_name:Access_token";
    ...
    public static void collectRepositories(int starsLimit, int contributorsLimit, int commitsLimit)
        ...
        System.out.println("Found " + allRepositories.size() + " Java GitHub repositories with at least 100 stars.");
